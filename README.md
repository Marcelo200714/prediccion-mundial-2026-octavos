...
*Probabilidades del clasificador 1X2 calibrado; la confianza final del
ganador predicho combina esas probabilidades con la simulación de Monte
Carlo (incluyendo penaltis en caso de empate). Datos completos en
[`output/predicciones_octavos.csv`](output/predicciones_octavos.csv).*
