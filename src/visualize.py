"""
Genera 'clasificados_octavos.png': una imagen limpia que muestra, sin
ambiguedad, que 8 selecciones avanzan de Octavos de Final a Cuartos de
Final segun el modelo (2 ya definidas en la cancha + 6 predichas por la
cascada XGBoost).
...
def generar_imagen(resultados, ruta_salida, fecha_corte="2026-07-05"):
    ...
    fig.text(0.5, 1 - (0.62 / fig_h), "Clasificados de Octavos de Final a Cuartos de Final",
              fontsize=20, color=INK_PRIMARY, ha="center", va="top", fontweight="bold")
    fig.text(0.5, 1 - (1.02 / fig_h),
              f"Prediccion generada por el modelo XGBoost en cascada  ·  corte de datos {fecha_corte}",
